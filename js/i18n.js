...
(function () {
  ...
  var EN = {
    ...
    'about.title': 'About',
    'about.photoAlt': 'Portrait of Taehyung Lim',
    'about.p1':
      "Hi, I'm Taehyung Lim, an aspiring frontend developer. I care about building interfaces where the user never has to stop and wonder what to do next.",
    'about.p2':
    ...
    'skills.usedDesc': "I've shipped with these and can work with the docs at hand.",
    'skills.learningTitle': 'Currently learning',
    'skills.learningDesc': "Not yet confident enough to claim — these are what I'm studying now.",
    ...
    'projects.p1Summary': '[TODO] One sentence describing what this project is.',
    'projects.p1Problem': '[TODO] What problem you set out to solve.',
    'projects.p1Solution': '[TODO] How you solved it and why you chose that approach.',
    ...
    'projects.p2Summary': '[TODO] One sentence describing what this project is.',
    'projects.p2Problem': '[TODO] What problem you set out to solve.',
    'projects.p2Solution': '[TODO] How you solved it and why you chose that approach.',
    ...
    'education.e1Desc': '[TODO] What you studied and your role on team projects.',
    'education.e2Title': '[TODO] University',
    'education.e2Meta': '[TODO] Major · B.A./B.S.',
    'education.e2Desc': '[TODO] Anything from your major that connects to development.',

    'contact.title': 'Contact',
    'contact.lead': "If there's a chance to work together, feel free to reach out anytime.",
    'contact.copy': 'Copy',
  ...
  function apply(lang) {
    ...
    if (btn) {
      ...
      btn.setAttribute('aria-label', lang === 'en' ? '한국어로 전환' : 'Switch to English');
    }
